...
if __name__ == '__main__':
    ...
    root_directory = "/root/project/hw-chat-0.4/scripts/course_data"
    ...
    # 加载 CSV 文件
    df = pd.read_csv("/root/project/hw-chat-0.4/scripts/course_data/course_metadata.csv")
    ...
    df.to_csv("/root/project/hw-chat-0.4/scripts/course_data/final_course.csv", index=False)
