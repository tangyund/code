...
# 定义检索器配置
retriever_config = {
    'data_dir': '/root/autodl-tmp/hw-chat/hw-chat-0.2/server/dataset/',
    'index_path': '/root/autodl-tmp/hw-chat/hw-chat-0.2/server/indexes/e5_flat_sample.index',
    'corpus_path': '/root/autodl-tmp/hw-chat/hw-chat-0.2/server/indexes/sample_data.jsonl',
    'device': 'cpu',
