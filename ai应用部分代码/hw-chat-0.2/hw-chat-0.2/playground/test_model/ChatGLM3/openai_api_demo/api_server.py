...
# set LLM path
MODEL_PATH = os.environ.get('MODEL_PATH', '/root/autodl-tmp/data/model/ZhipuAI/chatglm3-6b')
TOKENIZER_PATH = os.environ.get("TOKENIZER_PATH", MODEL_PATH)

# set Embedding Model path
EMBEDDING_PATH = os.environ.get('EMBEDDING_PATH', '/root/autodl-tmp/data/model/AI-ModelScope/bge-large-zh-v1___5')
...
if __name__ == "__main__":
    ...
    uvicorn.run(app, host='127.0.0.1', port=9091, workers=1)
