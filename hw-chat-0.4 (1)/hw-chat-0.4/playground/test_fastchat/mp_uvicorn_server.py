...
def start_model_worker():
    ...
    worker = ModelWorker(
        controller_addr="http://xx:21001",
        worker_addr="http://xxx:21002",
        worker_id=worker_id,
    ...
    uvicorn.run(worker_app, host="xxx", port=21002)
...
def start_openai_api_server():
    ...
    app_settings.controller_address = "http://xxx:21001"
    app_settings.api_keys = []
    api_app.title = "FastChat OpenAI API Server"
    uvicorn.run(api_app, host="xxx", port=8000)
