...
async def main():
    # 文件夹路径，包含所有PDF文件
    folder_path = '/root/autodl-tmp/hw-chat/hw-chat-0.2/knowledge_base/private/content'
...
async def wiki_main():
    ...
    file_path = "/root/autodl-tmp/hw-chat/hw-chat-0.2/knowledge_base/wiki/content/education.jsonl"
    # 创建一个空的 Document 列表
    docs = []
    # 打开文件并读取每一行
    try:
